...
from backend.app.services.officer_service import (
    create_officer, list_officers, get_officer_by_id,
    enable_officer, disable_officer
)
...
def register_officer(
    ...
    return create_officer(full_name, email, username, password, role, admin["officer_id"])
