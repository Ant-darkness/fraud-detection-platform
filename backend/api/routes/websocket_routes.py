...
def validate_security_config():
  if not INTERNAL_API_KEY:
    logger.error("🚨 CRITICAL: INTERNAL_API_KEY haijafafanuliwa kwenye .env!")


# ====================================================================
# 1. LIVE FEED WEBSOCKET (Auto Pulse + Interactive Timeframe Switch)
# ====================================================================
  ...
  async def push_updates():
    ...
    while True:
      try:
        ...
        logger.debug(f"Pulse task stopped or connection closed: {e}")
        break
