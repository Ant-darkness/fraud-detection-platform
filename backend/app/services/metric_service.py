...
def get_metrics(model_id: int):
    ...
    try:
        cursor = conn.cursor()
        cursor.execute("""
            SELECT precision_score, recall_score, f1_score, roc_auc, fraud_recall, nonfraud_recall, created_at
...
def get_leaderboard():
    ...
    try:
        ...
        cursor.execute("""
            ...
            ORDER BY mt.f1_score DESC, mt.fraud_recall DESC, mt.nonfraud_recall DESC
        """)
